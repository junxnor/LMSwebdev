...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($USER_ID !== false) {
        ...
        header("Location: /Group Assignment/Lecturer Interface/Token/Check_Token.php?email=" . urlencode(base64_encode($email)));

    } else {
        // User with the provided email does not exist
        echo "Error: Email not found.";
        echo '<script> history.go(-1) </script>';
        echo '<script>window.location.href = "/Group Assignment/Lecturer Interface/Token/Email_Token.html";</script>';
    }
