...
if (($databasePassword === null || $databasePassword === '') && ($providedPassword === null || $providedPassword === '')) {
    ...
    header("Location: /Group Assignment/Lecturer Interface/Token/View_Token.php?user_id=" . $user_id . "&Token_ID=" . $token_id);
    exit();
    ...
    if (password_verify($providedPassword, $databasePassword)) {
        ...
        echo '<script>window.location.href = "/Group Assignment/Lecturer Interface/Token/Check_Token_Password.php";</script>';
    }
} else {
