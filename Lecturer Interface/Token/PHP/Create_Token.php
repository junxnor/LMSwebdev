...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO token (Instructor_USER_ID, Email, Token_Name, Token_Question, Token_Files, Token_Password) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            echo 'window.location.href = "/Group Assignment/Lecturer Interface/Token/View_Token.php?user_id=' . $user_id . '&Token_ID=' . $last_inserted_id . '";';
            echo '</script>';
        } else {
