...
if (isset($_GET['user_id'])){
    ...
    $tokenAnswer = getTokenAnswerFromDatabase($user_id,$conn);
...
function getTokenAnswerFromDatabase($user_id, $conn) {
    $stmt = $conn->prepare("SELECT Token_Answer FROM token WHERE Instructor_USER_ID = ?");
    $stmt->bind_param('i', $user_id);
    $stmt->execute();
    $result = $stmt->get_result();
...
<body>
    ...
    <div class="Back-Button">
        <button onclick="window.location.href='/Group Assignment/Lecturer Interface/Token/Token_Home.html'">Back to Token HomePage</button>
     </div>
</body>
