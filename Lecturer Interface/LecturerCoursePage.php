...
<head>
    ...
    <title>Lecturer Dashboard - CourseVerse</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 900px) {
            nav.sidebar {
                display: none;
                /* hide sidebar on small screens, you can add toggle */
            }
...
<body>
    <header>
        ...
        <h1>CourseVerse</h1>
        <h1>Welcome - Lecturer <?php echo htmlspecialchars($prefixed_user_id); ?></h1>
    </header>
    ...
    <div class="container">
        ...
        <main class="content">
            ...
            <div class="Course-Box">
                <!-- Lecturer courses as boxes, styled same as student -->

                <div class="Box-2" onclick="window.location.href='/Group Assignment/Uploads/Module_1/LecturerModule1.html'">
                    <img src="/Group Assignment/Picture/Math Module.jpeg" alt="Module 1" />
                    <h4>Module 1</h4>
                    <div class="progress-container">
                        <label>Your Progress:</label>
                        <progress id="Lecturer-Math-1-Progress" value="0" max="100"></progress>
                    </div>
                </div>

                <div class="Box-2" onclick="window.location.href='/Group Assignment/Uploads/Module_2/LecturerModule2.html'">
                    <img src="/Group Assignment/Picture/Math Module.jpeg" alt="Module 2" />
                    <h4>Module 2</h4>
                    <div class="progress-container">
                        <label>Your Progress:</label>
                        <progress id="Lecturer-Math-2-Progress" value="0" max="100"></progress>
                    </div>
                </div>

                <div class="Box-2" onclick="window.location.href='/Group Assignment/Uploads/Module_3/LecturerModule3.html'">
                    <img src="/Group Assignment/Picture/Math Module.jpeg" alt="Module 3" />
                    <h4>Module 3</h4>
                    <div class="progress-container">
                        <label>Your Progress:</label>
                        <progress id="Lecturer-Math-3-Progress" value="0" max="100"></progress>
                    </div>
                </div>

                <div class="Box-2" onclick="window.location.href='/Group Assignment/Uploads/Module_4/LecturerModule4.html'">
                    <img src="/Group Assignment/Picture/Math Module.jpeg" alt="Module 4" />
                    <h4>Module 4</h4>
                    <div class="progress-container">
                        <label>Your Progress:</label>
                        <progress id="Lecturer-Math-4-Progress" value="0" max="100"></progress>
                    </div>
                </div>
            </div>
