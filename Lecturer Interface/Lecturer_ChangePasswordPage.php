...
<body>
    ...
    <div class="AllHeader">
        ...
        <nav id="navBar">
            ...
            <div class="SideBar">
                <ul class="StudentButton">
                    ...
                    <li onclick="window.location.href='/Group Assignment/Lecturer Interface/Lecturer_Profile.php'">Profile</li>
                </ul>
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Lecturer Interface/PHP/Lecturer_CheckNewPassword.php" method="post" onsubmit="return CheckPassword()">
