...
<body>
    ...
    <div class="Profile">
        ...
        <div class="">
        <button onclick="window.location.href='/Group Assignment/Lecturer Interface/Lecturer_CheckSecurityWord.php'">Change Password</button>

        </div>
        <br>
        <br>
        <div class="Back-Button">
        <button onclick="window.location.href='/Group Assignment/Lecturer Interface/LecturerCoursePage.php'">Back to Home Page</button>
        </div>
