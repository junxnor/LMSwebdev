...
<body>
    ...
    <div class="AllHeader">
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Lecturer Interface/PHP/Lecturer_ForgotPassword_CheckNewPassword.php?email=<?php echo urlencode(base64_encode($email)); ?>" method="post" onsubmit="return CheckPassword()">
        ...
        <br>
        <div class="Back">
        <button onclick="window.location.href='/Group Assignment/Lecturer Interface/Lecturer_ForgotPassword_CheckSecurityWord.php?email=<?php echo urlencode(base64_encode($email)); ?>'">back</button>
        </div>
