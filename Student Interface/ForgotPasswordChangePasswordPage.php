...
<body>
    ...
    <div class="AllHeader">
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/PHP/ForgotPasswordCheckNewPassword.php?email=<?php echo urlencode(base64_encode($email)); ?>" method="post" onsubmit="return CheckPassword()">
                <label>New Password:</label>
                <input type="password" name="NewUserPassword" placeholder="Please enter a Password" id="Password" required><br>
                <label>Retype New Password:</label>
                <input type="password" name="RetypeNewUserPassword" placeholder="Please enter a Retype Password" id="RetypePassword" required><br>
                <br>
        ...
        <div class="Back">
        <button onclick="window.location.href='/Group Assignment/Student Interface/ForgotPasswordCheckSecurityWord.php?email=<?php echo urlencode(base64_encode($email)); ?>'">back</button>
        </div>
    </div>
    <hr>
