...
$query = "SELECT USER_ID, Email, Token_Question, Token_ID FROM token";
...
<br>
<hr>
<button class="back-btn" onclick="window.location.href='/Group Assignment/Student Interface/Email_Token.html'">Back</button>
    <table>
        <tr>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($row["USER_ID"] == $USER_ID) {
                ...
                echo '<td><a class="edit-btn" href="/Group Assignment/Student Interface/Check_Token_Password.php?user_id=' . $row["USER_ID"] . '&Token_ID=' . $row["Token_ID"] . '">View Token</a>';
                echo '<a class="delete-btn" href="/Group Assignment/PHP/Delete_Token.php?user_id=' . $row["USER_ID"] .'&Token_ID=' . $row["Token_ID"] . '" onclick="return confirm(\'Are you sure?\')">Delete</a></td>';
                echo "</tr>";
            }
        }
