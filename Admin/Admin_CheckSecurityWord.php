...
function getSecurityWordFromDatabase($user_id, $conn) {
    $stmt = $conn->prepare("SELECT SecurityWord FROM admin_password WHERE Admin_USER_ID = ?");
...
<body>
    ...
    <form method="post" action="/Group Assignment/Admin/PHP/Admin_CheckSecurityWord.php">
