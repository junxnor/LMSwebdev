...
if (isset($_GET['user_id'])){
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["NewLastName"])) {
            ...
            $updateFirstNameQuery = "UPDATE users SET Last_NAME=? WHERE USER_ID=?";
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                echo '<script>window.location.href = "/Group Assignment/Admin/Change Student/Change_Student_LastName.php?user_id=' . $user_id . '";</script>';
            }
