...
if (isset($_GET['user_id'])) {
    ...
    header("Location: /Group Assignment/Admin/Manage_Student_Account.php");
...
<body>
    ...
    <div class="Profile">
        ...
        <ul class="Profile-Drawer">
            ...
            <button onclick="window.location.href='/Group Assignment/Admin/Change Student/Change_Student_FirstName.php?user_id=<?php echo $user_id?>'">Change First Name</button>
            </div>
        </ul>
        <ul class="Profile-Drawer">
            <p>Last Name</p>
            ...
            <div class="Change-Box">
            <button onclick="window.location.href='/Group Assignment/Admin/Change Student/Change_Student_LastName.php?user_id=<?php echo $user_id?>'">Change Last Name</button>
            </div>
        </ul>
        <ul class="Profile-Drawer">
            <p>Email</p>
            ...
            <div class="Change-Box">
            <button onclick="window.location.href='/Group Assignment/Admin/Change Student/Change_Student_Email.php?user_id=<?php echo $user_id?>'">Change Email</button>
            </div>
        </ul>
        <ul class="Profile-Drawer">
            <p>Password</p>
            ...
            <div class="Change-Box">
            <button onclick="window.location.href='/Group Assignment/Admin/Change Student/Change_Student_Password.php?user_id=<?php echo $user_id?>'">Change Password</button>
