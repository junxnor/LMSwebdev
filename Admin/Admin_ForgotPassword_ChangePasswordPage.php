...
<body>
    ...
    <div class="AllHeader">
        ...
        <hr>
        <div class="Back">
        <button onclick="window.location.href='/Group Assignment/Admin/Admin_ForgotPassword_CheckSecurityWord.php?email=<?php echo urlencode(base64_encode($email)); ?>'">back</button>
        </div>
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Admin/PHP/Admin_ForgotPassword_CheckNewPassword.php?email=<?php echo urlencode(base64_encode($email)); ?>" method="post" onsubmit="return CheckPassword()">
