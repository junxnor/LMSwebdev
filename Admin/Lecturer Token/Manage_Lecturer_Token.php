...
$query = "SELECT CONCAT('L', token.Instructor_USER_ID) AS Prefixed_Instructor_User_ID, token.Instructor_USER_ID,CONCAT('T', token.Token_ID) AS Prefixed_Token_ID, token.Token_ID, token.Token_Name, token.Token_Question, token.Token_Answer, token.Email
          FROM token
          JOIN instructor_email ON token.Instructor_USER_ID = instructor_email.Instructor_USER_ID";
...
<body>
    ...
    <table id="Student-Data">
        ...
        while ($row = $result->fetch_assoc()){
            ...
            echo '<td><a class="edit-btn" href="/Group Assignment/Admin/Lecturer Token/Admin_Lecturer_Token.php?user_id='.$row['Instructor_USER_ID'].'&token_id='.$row['Token_ID'].'">Manage</a></td>';
            echo '<td><a class="delete-btn" href="/Group Assignment/Admin/Lecturer Token/PHP/Delete_Lecturer_Token.php?user_id='.$row['Instructor_USER_ID'].'&token_id='.$row['Token_ID'].'">Delete</a></td>';
            echo '</tr>';
        }
        ?>
    </table>
