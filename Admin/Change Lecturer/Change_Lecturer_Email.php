...
<body>
    ...
    <div class="AllHeader">
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Admin/Change Lecturer/PHP/Change_Lecturer_Email.php?user_id=<?php echo $user_id?>" method="post" >
            <label>New Email:</label>
            <input type="email" name="NewEmail" placeholder="Please enter a New Email" id="Email" required><br>
            <br>
