...
if (isset($_GET['user_id'])){
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["NewLastName"])) {
            ...
            $updateFirstNameQuery = "UPDATE instructor SET Instructor_Last_NAME=? WHERE Instructor_USER_ID=?";
            $stmt = mysqli_prepare($conn, $updateFirstNameQuery);
            mysqli_stmt_bind_param($stmt, "ss", $newLastName, $user_id);
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                echo '<script>window.location.href = "/Group Assignment/Admin/Change Lecturer/Change_Lecturer_LastName.php?user_id=' . $user_id . '";</script>';
            }
            ...
            echo '<script>window.location.href = "/Group Assignment/Admin/Change Lecturer/Change_Lecturer_LaststName.php?user_id=' . $user_id . '";</script>';
        }
    }
    else {
