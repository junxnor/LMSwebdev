...
<body>
    ...
    <div class="AllHeader">
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Admin/Change Lecturer/PHP/Change_Lecturer_FirstName.php?user_id=<?php echo $user_id?>" method="post" onsubmit="return CheckPassword()">
            <label>New First Name:</label>
            <input type="text" name="NewFirstName" placeholder="Please enter a New FirstName" id="FirstName" required><br>
            <br>
