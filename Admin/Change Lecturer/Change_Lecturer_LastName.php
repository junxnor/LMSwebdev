...
<body>
    ...
    <div class="AllHeader">
        ...
        <div class="Change-Password-Box">
            <form action="/Group Assignment/Admin/Change Lecturer/PHP/Change_Lecturer_LastName.php?user_id=<?php echo $user_id?>" method="post" onsubmit="return CheckPassword()">
