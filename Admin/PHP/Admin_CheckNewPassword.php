    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($_POST["NewUserPassword"] == $_POST["RetypeNewUserPassword"]) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                echo '<script>window.location.href = "/Group Assignment/Admin/Profile.php";</script>';
            } else {
                echo '<script> alert("Error updating password: ")</script>' . mysqli_stmt_error($stmt);
                echo '<script>window.location.href = "/Group Assignment/Admin/Admin_ChangePasswordPage.php";</script>';
            }
