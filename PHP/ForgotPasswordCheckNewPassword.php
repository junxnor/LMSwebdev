...
if (isset($_GET['email'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($_POST["NewUserPassword"] == $_POST["RetypeNewUserPassword"]) {
            ...
            $updatePasswordQuery = "UPDATE userpassword SET PASSWORD=? WHERE USER_ID=?";
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                echo '<script>window.location.href = "/Group Assignment/Student Interface/ForgotPasswordChangePasswordPage.php?email=<?php echo urlencode(base64_encode($email)); ?>";</script>';
            }
    ...
    echo '<script>window.location.href = "/Group Assignment/Student Interface/CheckEmail.html";</script>';
}
