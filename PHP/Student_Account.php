...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $emailCheckQuery = "SELECT * FROM email WHERE Email = '$email'";
    ...
    if ($resultEmailCheck === FALSE) {
        ...
        if ($resultEmailCheck->num_rows > 0) {
            ...
            $sql = "INSERT INTO users (First_Name, Last_Name, Gender) VALUES ('$first_name', '$last_name' ,'$gender')";
            if ($conn->query($sql) === TRUE) {
                ...
                $sqlEmail = "INSERT INTO email (USER_ID, Email) VALUES ('$user_id', '$email')";
                ...
                $sqlPassword = "INSERT INTO userpassword (USER_ID, PASSWORD,SecurityWord) VALUES ('$user_id', '$password','$securityword')";
